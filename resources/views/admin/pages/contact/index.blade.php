          ...
          <div class="accordion-item">
            ...
            <div class="accordion-collapse collapse" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
              <div class="accordion-body pt-0">
                  <form action="{{ route('admin.contact.basic') }}" method="POST">
                      @csrf
            ...
            <div class="accordion-collapse collapse" id="collapseTwo" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div class="accordion-body pt-0">
                  <form action="" method="POST">
                      @csrf
                      <input type="text" class="form-control" value="{{ $get_data->google_map }}" placeholder="Enter Google Map Embeded URL"><br>
                      <button type="submit" class="btn btn-success">Save</button>
                  </form>
              </div>
            </div>
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-collapse collapse" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body pt-0">
                  <form action="" method="POST">
                      @csrf
                      <input type="text" placeholder="Email" value="{{ $get_data->email }}" class="form-control">
                      <input type="text" placeholder="Phone Number" value="{{ $get_data->phone }}" class="form-control">
                      <input type="text" placeholder="Address / Location" value="{{ $get_data->address }}" class="form-control">
                      <br>
                      <button type="submit" class="btn btn-success">Save</button>
                  </form>
              </div>
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-collapse collapse" id="collapseFour" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
              <div class="accordion-body pt-0">
                  <form action="" method="POST">
                      @csrf
                      <input type="text" class="form-control" value="{{ $get_data->facebook }}" placeholder="Facebook "><br>
                      <input type="text" class="form-control" value="{{ $get_data->twitter }}" placeholder="Twitter"><br>
                      <input type="text" class="form-control" value="{{ $get_data->instagram }}" placeholder="Instagram"><br>
                      <input type="text" class="form-control" value="{{ $get_data->linkedin }}" placeholder="Linkedin"><br>
                      <button type="submit" class="btn btn-success">Save</button>
                  </form>
              </div>
            </div>
