@extends('master')
@section('page_title','Search | '.request()->query('keywords'))
@section('MainContent')
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Your seach result for</h1>
              <span class="color-text-a">{{ request()->query('keywords') }}</span>
            </div>
          </div>
...
@if($get_all_properties->count() > 0)
  ...
  @else
  <h6 class="text-center">There is no property</h6>
@endif
  </main><!-- End #main -->
  <form id="filterForm">
